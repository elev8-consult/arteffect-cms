...
export interface ApiArtistArtist extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    artisticStyle: Schema.Attribute.String & Schema.Attribute.Required;
    ...
    featured: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<false>;
    fullBio: Schema.Attribute.Blocks & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::artist.artist'
    ...
    publishedAt: Schema.Attribute.DateTime;
    relatedDesigns: Schema.Attribute.Relation<
      'oneToMany',
      'api::design.design'
    >;
...
export interface ApiContactSubmissionContactSubmission
  ...
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<
      ['artist', 'ngo', 'collaborator', 'general']
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiDesignDesign extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    artisticInspiration: Schema.Attribute.Text;
    concept: Schema.Attribute.Text & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiDropDrop extends Struct.CollectionTypeSchema {
...
export interface ApiImpactReportImpactReport
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    label: Schema.Attribute.Component<'metrics.metrics', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiNgoNgo extends Struct.CollectionTypeSchema {
  collectionName: 'ngos';
  info: {
    displayName: 'NGO';
    pluralName: 'ngos';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    featured: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    focusArea: Schema.Attribute.String;
    fullDescription: Schema.Attribute.Blocks & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::ngo.ngo'> &
      Schema.Attribute.Private;
